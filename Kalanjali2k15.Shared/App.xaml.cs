...
using Kalanjali2k15.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using Kalanjali2k15.AppFlyouts;
#endif
...
namespace Kalanjali2k15
{
    ...
    {
        private Guid APP_ID = new Guid("7e926222-37d4-4f24-a7f1-c2f5a8dff58a");
        public const string APP_NAME = "Kalanjali2k15";
        ...
        private void UpdateAppTiles()
        {
            ...
            {
                TileServices.CreateFlipTile(@"kalanjali 2k15", @"Its carnival time !!!");
